...
def convert(init_label, label, classes):
    init_label["imagePath"] = label["image"]
...
class Labelme:
    ...
    def load(self, label, func = convert):
        ...
        classes = None
        if self.CLASSES == None:
            classes = {self.CLASSES[key] : key for key in self.CLASSES.keys()}
            label, _ = func(init_label, label, classes)
        else:
            classes = self.CLASSES
            label, self.CLASSES = func(init_label, label, classes)
